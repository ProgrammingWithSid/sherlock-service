      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSignup">
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-gray-50 text-gray-500">Or connect with</span>
          </div>
        </div>
...
const connectWithGitHub = async (): Promise<void> => {
  loading.value = true
  error.value = null
  ...
  try {
    ...
    error.value = err instanceof Error ? err.message : 'Failed to initiate GitHub connection'
    loading.value = false
  }
}

const connectWithGitLab = async (): Promise<void> => {
  loading.value = true
  error.value = null
  ...
  try {
    ...
    error.value = err instanceof Error ? err.message : 'Failed to initiate GitLab connection'
    loading.value = false
  }
}
</script>
